...
const App=({navigation})=>{
    ...
    const validate = () => {
        ...
        navigation.navigate('ManageOrganizations');
        }
    };
...
return (
    ...
    <Text title="Pannel" style={styles.textStyle}>User Login</Text>
    ...
    <TouchableOpacity>
        <Text style={styles.register_button} onPress={()=>navigation.navigate('Register_user')}>Create Account/Register</Text> 
    </TouchableOpacity> 
