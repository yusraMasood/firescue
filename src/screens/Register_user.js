...
import { View, Text, TextInput, Button,StyleSheet,Image,StatusBar,TouchableOpacity,Modal,TouchableHighlight,Alert } from 'react-native';
...
return (
    ...
    <Text title="Pannel" style={styles.textStyle}>REGISTRATION USER</Text>
    ...
    <TouchableOpacity>
        <Text style={styles.register_button} onPress={()=>navigation.navigate('User_login')}>Back to Login</Text> 
    </TouchableOpacity> 
