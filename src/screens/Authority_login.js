...
export default function Authority_login({navigation}) {
...
const validate = () => {
    ...
    navigation.navigate("Authority_Dashboard");
    }
};
...
return (
    ...
    <Text title="Pannel" style={styles.textStyle}>Authority Login</Text>
